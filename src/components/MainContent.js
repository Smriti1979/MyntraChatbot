...
const MainContent = ({ name }) => {
  ...
  return (
    <div className="flex-1 p-8">
      ...
      <div className="p-3 flex justify-center fix-bottom-2 mt-20">
        <input
          type="text"
          placeholder="Ask for best recommendation"
          className="w-1/2 p-3 border-2 border-gray-300 rounded-l-lg focus:outline-none focus:border-pink-500"
        />
        <button className="p-3 bg-pink-500 text-white rounded-r-lg">
